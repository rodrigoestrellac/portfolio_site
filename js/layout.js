...
/* ─── 3. Shared markup ─────────────────────────────────────── */
var SITE_NAV_HTML = [
  '<a class="skip-link" href="#contenido"><span data-lang-es>Saltar al contenido</span><span data-lang-en>Skip to content</span></a>',
  '<nav class="site-navbar" id="site-navbar" aria-label="Principal">',
  '  <a class="navbar-brand" href="./">Rodrigo <span>Estrella</span></a>',
  '  <button class="nav-burger" id="nav-burger" aria-label="Abrir menú" aria-expanded="false" aria-controls="nav-panel">',
  '    <span></span><span></span><span></span>',
  '  </button>',
  '  <div class="nav-panel" id="nav-panel">',
  '    <ul class="nav-links">',
  '      <li><a class="nav-link" data-page="index" href="./"><span data-lang-es>Inicio</span><span data-lang-en>Home</span></a></li>',
  '      <li><a class="nav-link" data-page="proyectos" href="./#proyectos"><span data-lang-es>Proyectos</span><span data-lang-en>Projects</span></a></li>',
  '      <li><a class="nav-link" data-page="servicios" href="./#servicios"><span data-lang-es>Servicios</span><span data-lang-en>Services</span></a></li>',
  ...
  '          <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="11" height="11"><path d="M6 9l6 6 6-6"/></svg>',
  '        </button>',
...
var SITE_FOOTER_HTML = [
  ...
  '    <a href="./#proyectos"><span data-lang-es>Proyectos</span><span data-lang-en>Projects</span></a>',
  '    <a href="./#servicios"><span data-lang-es>Servicios</span><span data-lang-en>Services</span></a>',
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Escape cierra menú mobile y dropdowns */
